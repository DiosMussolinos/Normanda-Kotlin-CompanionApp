...
import com.example.normanda_capp.TimerNotificationActionReceiver
...
class NotificationUtil {
    companion object{
        ...
        fun showTimerExpired(context: Context){
            ...
            val startPedingIntent = PendingIntent.getBroadcast(context, 0, startIntent, PendingIntent.FLAG_UPDATE_CURRENT)
        ...
        fun showTimerRunning(context: Context, wakeUpTime:Long){
            ...
            val df = SimpleDateFormat.getTimeInstance(SimpleDateFormat.FULL)
